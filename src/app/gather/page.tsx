...
export const metadata = {
  ...
  description:
    "Quick activity suggestions by mood, budget, companions, and interests.",
};
...
export default async function GatherPage({ sp = {} }: PageProps) {
  ...
  const raw = {
    ...
    budget:
      typeof searchParams.budget === "string" ? searchParams.budget : undefined,
    companions:
      typeof searchParams.companions === "string"
    ...
    <main className="min-h-[80vh] p-6 text-neutral-100 bg-neutral-950">
      <div className="mx-auto max-w-5xl">
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">
          Gather Ideas — Plan Generator
        </h1>
        <p className="mt-2 text-neutral-300">
          Tune your mood, budget, companions, and interests to get ranked
          suggestions.
        </p>
